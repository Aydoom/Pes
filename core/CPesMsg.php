    ...
    static public function display($msg){
        ...
        if(is_array($msg)){
            foreach($msg as $key => $str){
                $msg[$key]['old'] = CPesFormat::inUtf8($str['old']);
            }
        }
        else{
        ...
        if(self::$style == 0){
            echo "
                <style>
                    ...
                    div,table,ul,ol,dl{border: 1px solid #482d06;width: 95%;margin: 5px 1%;}
                    ...
                    .error{background-color: #ff0000;margin: 1% 2.5%; padding: 0 2.5%; width 95%}
                    .notes{background-color: #fff600;margin: 1% 2.5%; padding: 0 2.5%; width 95%}
                    .message{background-color: #8bf673;margin: 1% 2.5%; padding: 0 2.5%; width 95%}
                </style>";
            self::$style = 1;
        }
    }
